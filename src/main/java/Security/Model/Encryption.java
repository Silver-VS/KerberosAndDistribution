...
public class Encryption {
    ...
    public static String encryptSymmetric(SecretKey secretKey, String toEncrypt) throws Exception {
        Cipher encryptCypher = Cipher.getInstance("DES");
        encryptCypher.init(Cipher.ENCRYPT_MODE, secretKey);
        return encrypt(encryptCypher, toEncrypt);
    }

    public static String decryptSymmetric(SecretKey secretKey, String toDecrypt) throws Exception {
